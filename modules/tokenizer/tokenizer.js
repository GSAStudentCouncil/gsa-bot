...
const tokenizer = new Tokenizer({
    "급식": ["급식", "밥", "끼니", "음식", "학식", "병영식", "메뉴", "짬", "짬밥", "식단", "먹", "뭐나", "머나"],
    "아침": ["아침", "조식", "아침밥", "아침급식", "브렉퍼스트"],
    "점심": ["점심", "정오", "중식", "점심밥", "점심급식", "런치"],
    "저녁": ["저녁", "석식", "저녁밥", "저녁급식", "디너"],
    "오늘": ["오늘", "금일", "금날", "당일", "투데이", "0일", "+0일"],
    "내일": ["내일", "내날", "하제", "명일", "익일", "투모로우", "+1일"],
    "모레": ["모레", "내일모레", "낼모레", "명후일", "재명일", "+2일"],
    "글피": ["글피", "삼명일", "저모레", "+3일"],
    "그글피": ["그글피", "저글피", "저낙날", "+4일"],
    "어제": ["어제", "전날", "어저께", "작일", "-1일"],
    "그제": ["그제", "전전날", "그저께", "거거일", "재작", "재작일", "-2일"],
    "그끄저께": ["그끄저께", "그끄제", "삼작일", "재재작일", "-3일"],
});
