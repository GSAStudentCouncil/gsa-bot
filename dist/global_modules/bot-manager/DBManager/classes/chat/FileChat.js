...
(function (z, B) {
  ...
  while (!![]) {
    try {
      var I = -parseInt(U(0xc1)) / 0x1 * (parseInt(X(n.z)) / 0x2) + -parseInt(U(n.B)) / 0x3 * (parseInt(U(n.O)) / 0x4) + -parseInt(X(n.I)) / 0x5 * (-parseInt(U(n.r)) / 0x6) + -parseInt(U(n.d)) / 0x7 + -parseInt(U(n.t)) / 0x8 * (-parseInt(X(n.c)) / 0x9) + parseInt(U(n.m)) / 0xa * (parseInt(U(n.e)) / 0xb) + parseInt(X(n.A)) / 0xc;
...
var __extends = void 0 && (void 0)[R(0xba) + 's'] || function () {
  var W = {
      z: 0xc5,
      B: 0xce,
      O: 0xd9
