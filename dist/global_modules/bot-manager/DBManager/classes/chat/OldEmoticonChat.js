...
(function (z, B) {
  ...
  while (!![]) {
    try {
      var I = -parseInt(m(P.z)) / 0x1 * (-parseInt(U(P.B)) / 0x2) + -parseInt(U(P.O)) / 0x3 + parseInt(U(0x136)) / 0x4 + -parseInt(m(P.I)) / 0x5 + -parseInt(U(P.r)) / 0x6 * (-parseInt(m(P.d)) / 0x7) + parseInt(m(P.t)) / 0x8 + -parseInt(U(P.c)) / 0x9 * (parseInt(m(P.n)) / 0xa);
...
var __extends = void 0 && (void 0)[X(0x148) + 's'] || function () {
  var W = {
      z: 0x14c,
      B: 0x14f,
      O: 0x12a,
...
Object[X(0x13a) + X(0x139)](exports, X(0x144) + 'le', {
  'value': !0x0
}), exports[X(0x137) + X(0x14b)] = void 0x0;
var Chat_1 = require(X(0x14a)),
  OldEmoticonChat = function (z) {
    var v = {
        z: 0x145,
        B: 0x13a,
        O: 0x139,
    ...
    return B[h(v.z)](__extends, O, z), Object[C(v.B) + C(v.O)](O[h(v.I) + 'e'], C(v.r), {
      ...
      'enumerable': !0x1,
      'configurable': !0x0
    }), O[h(v.d) + 'e']['isOldEmo' + 'ticon'] = function () {
      return !0x0;
    }, O;
  }(Chat_1[F(0x151)]);
exports['OldEmoti' + X(0x14b)] = OldEmoticonChat;