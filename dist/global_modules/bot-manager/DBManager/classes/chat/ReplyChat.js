...
(function (z, B) {
  ...
  while (!![]) {
    try {
      var I = parseInt(U(A.z)) / 0x1 * (parseInt(X(A.B)) / 0x2) + -parseInt(X(A.O)) / 0x3 * (-parseInt(U(A.I)) / 0x4) + parseInt(U(0xea)) / 0x5 * (parseInt(U(A.r)) / 0x6) + parseInt(X(A.d)) / 0x7 * (-parseInt(U(A.t)) / 0x8) + -parseInt(U(0xce)) / 0x9 + -parseInt(X(A.c)) / 0xa * (parseInt(X(A.m)) / 0xb) + parseInt(X(A.Q)) / 0xc;
...
var __extends = void 0 && (void 0)[R(0xc6) + 's'] || function () {
  var Y = {
      z: 0xd3,
      B: 0xf1,
      O: 0xf3,
...
var Chat_1 = require(R(0xf2)),
  db_util_1 = require(h(0xdc) + R(0xef) + h(0xf4)),
  ReplyChat = function (z) {
    var f = {
        z: 0xc8,
        B: 0xc3,
        O: 0xe3,
    ...
    return B[E(0xcd)](__extends, O, z), Object[C(0xd4) + C(f.O)](O[C(0xd5) + 'e'], B[C(f.I)], {
      ...
      'enumerable': !0x1,
      'configurable': !0x0
    }), O[E(f.t) + 'e'][C(f.c)] = function () {
      return !0x0;
    }, O;
  }(Chat_1['Chat']);
exports[R(0xca) + 't'] = ReplyChat;