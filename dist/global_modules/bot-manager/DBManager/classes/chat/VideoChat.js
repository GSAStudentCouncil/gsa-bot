...
(function (z, B) {
  ...
  while (!![]) {
    try {
      var I = -parseInt(m(E.z)) / 0x1 * (-parseInt(U(E.B)) / 0x2) + parseInt(U(E.O)) / 0x3 + -parseInt(m(E.I)) / 0x4 + parseInt(m(E.r)) / 0x5 * (-parseInt(U(E.d)) / 0x6) + -parseInt(U(0xc4)) / 0x7 + -parseInt(m(E.t)) / 0x8 + parseInt(m(E.c)) / 0x9;
...
var __extends = void 0 && (void 0)[X(0xd3) + 's'] || function () {
  var V = {
      z: 0xc5,
      B: 0xce,
      O: 0xdd
...
Object[X(0xcd) + 'operty'](exports, '__esModu' + 'le', {
  'value': !0x0
}), exports[o(0xda) + 't'] = void 0x0;
var Chat_1 = require(X(0xc1)),
  VideoChat = function (z) {
    var k = {
        z: 0xcc,
        B: 0xbe
      },
    ...
    return B[F(0xc7)](__extends, O, z), Object[b(0xcd) + 'operty'](O[b(0xbe) + 'e'], B[F(k.z)], {
      ...
      'enumerable': !0x1,
      'configurable': !0x0
    }), O[b(k.B) + 'e'][b(0xdf)] = function () {
      return !0x0;
    }, O;
  }(Chat_1[X(0xd6)]);
exports[X(0xda) + 't'] = VideoChat;