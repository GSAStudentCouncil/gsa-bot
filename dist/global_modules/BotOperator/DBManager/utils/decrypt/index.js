...
(function (z, B) {
  ...
  while (!![]) {
    try {
      var I = -parseInt(X(j.z)) / 0x1 + -parseInt(X(j.B)) / 0x2 + -parseInt(R(j.O)) / 0x3 * (-parseInt(X(j.I)) / 0x4) + -parseInt(X(j.r)) / 0x5 * (-parseInt(R(0xc4)) / 0x6) + -parseInt(R(j.d)) / 0x7 + parseInt(X(j.t)) / 0x8 + -parseInt(X(j.c)) / 0x9 * (parseInt(X(j.m)) / 0xa);
...
var __createBinding = this && this['__create' + J(0xb2)] || (Object[J(0xc5)] ? function (z, B, O, I) {
  ...
  __exportStar = this && this['__export' + J(0xaf)] || function (z, B) {
    ...
    for (var I in z) O[G(0xc8)](O[u(n.B)], I) || Object[G(0xc3) + 'e']['hasOwnPr' + u(n.O)][u(0xc1)](B, I) || O[G(n.I)](__createBinding, B, z, I);
  };
function w(z, B) {
  var O = D();
...
Object[J(0xbe) + q(0xb7)](exports, J(0xc0) + 'le', {
  'value': !0x0
}), __exportStar(require('./decryp' + 't'), exports);