...
export type Execute = (chat: Chat, channel: Channel, self: Command, args: Args) => void;
export type ExecuteLazy = (chat: Chat, prevChat: Chat, channel: Channel, prevChannel: Channel, self: Command, args: Args) => void;
